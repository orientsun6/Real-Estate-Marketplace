...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0x0), 'New address is not valid');
        _owner = newOwner;
         emit OwnershipTransfered(_owner);
    }
}
...
contract Pausable is Ownable {
    ...
    modifier paused() {
        require(_paused == true, 'Contact is not paused!');
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, 'You already own the token!');
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(_tokenApprovals[tokenId] != address(0), 'Token Id is not approved!');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, 'You are not the owner of the token!');
